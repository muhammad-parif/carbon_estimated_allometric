...
# carbon_estimated
#
# This plugin can be used to estimate carbon stocks and removals through plant biomass using allometric equations
#							 -------------------
#		begin				: 2026-09-02
#		git sha				: $Format:%H$
#		copyright			: (C) 2026 by Devi Wulandari & Muhammad Parif
...
SOURCES = \
	__init__.py \
	carbon_estimated_allometric.py carbon_estimated_allometric_dialog.py

PLUGINNAME = carbon_estimated_allometric

PY_FILES = \
	__init__.py \
	carbon_estimated_allometric.py carbon_estimated_allometric_dialog.py

UI_FILES = carbon_estimated_allometric_dialog_base.ui
