...
__date__ = '2026-09-02'
__copyright__ = 'Copyright 2026, Devi Wulandari & Muhammad Parif'
...
from carbon_estimated_allometric_dialog import carbon_estimatedDialog
...
class carbon_estimatedDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = carbon_estimatedDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(carbon_estimatedDialogTest)
